...
pending_deposits_to_delegate, in BC)
    ...
    apply_pending_deposit
        Applies the deposit itself, after checking signature validity. Decides if a new Delegator or top up is needed.
    ...
    is_withdrawable_from_delegator
        TODO: not used!!

    deposit_to_delegator_balance (BCA)
